...
//   value: any,
//   nullable: { items: boolean; list: boolean } | boolean | undefined,
// ): any {
//   if (!nullable) {
//     return value;
//   }
...
//     const nextContext =
//       typeof nextContextOrContextFunction === 'function'
...
//     const nextService =
//       typeof nextServiceOrServiceFunction === 'function'
...
//     const nextLayer =
//       typeof nextLayerOrLayerFunction === 'function'
...
//   // Check if result is a failure, if so, throw it.
//   checkAndThrowResultIfFailure(
//     result,
//     effect.failErrorConstructor || effectOptions?.defaultFailErrorConstructor,
//   );
